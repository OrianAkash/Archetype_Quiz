/* ============================================================
   ...
   Turtle, Cat, Monkey, Humming Bird. Option A is always
   the red button, so that would have made the red button
   one fixed archetype on all thirteen questions — players spot that
    ...
    },
    {
      ...
      options: [
        { text: 'More art and ways to express myself',
          scores: { hummingbird: 3, turtle: 1 } },
        { text: 'More fun things to do and discover',
          scores: { monkey: 3, cat: 1 } }
      ]
    },
    {
      // Q9
